...
fprintf('------------------------------------------------------------------\n')
summary(data)
statarray = grpstats(data,'good_quality');
...
%title('Target Variable : Class Imbalance')
...
%title('Parallel Coordinates of Numeric Attributes by Target Class - Median and 2 Quartiles');
xtickangle(45);
